...
import { LayoutDashboard, ArrowRightLeft, LogOut, Menu, X, User, TrendingUp, Target, Briefcase } from "lucide-react"
import { cn } from "@/lib/utils"
import NotificationBell from "@/components/notification-bell"

export default function ConsumableJuniorsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (mounted && !useAuthStore.getState().isLoading && !user) {
      router.push("/login")
    } else if (mounted && user && user.role !== "consumable_juniors" && user.role !== "admin") {
  ...
  const navItems = [
    { href: "/consumable_juniors/daily-activity", label: "Daily Activity", icon: TrendingUp },
    { href: "/consumable_juniors/kpi", label: "My KPI", icon: Target },
    { href: "/consumable_juniors/lead-transfer", label: "Lead Transfer", icon: ArrowRightLeft },
    { href: "/consumable_juniors/project-tender", label: "Project/Tender", icon: Briefcase },
    { href: "/consumable_juniors/profile", label: "Profile", icon: User },
  ]
