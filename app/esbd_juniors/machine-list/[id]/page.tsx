  ...
  if (!machine) {
    return (
      <div className="text-center py-16 text-slate-500">
        ...
        <Button variant="outline" className="mt-4" onClick={() => router.push("/esbd_juniors/machine-list")}>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => router.push("/esbd_juniors/machine-list")}>
