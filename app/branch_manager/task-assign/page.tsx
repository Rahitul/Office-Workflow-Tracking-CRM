    ...
    const fetchUsers = async () => {
      try {
        ...
        if (data.users) {
          ...
          const filtered = data.users.filter((u: UserData) => ["service", "service_juniors", "esbd_juniors", "branch_manager", "branch_manager_juniors", "branch_service", "branch_service_juniors", "branch_sales", "branch_sales_juniors", "branch_consumable", "branch_consumable_juniors", "branch_accounts", "branch_accounts_juniors"].includes(u.role))
          setUsers(filtered)
        }
      } catch (error) {
