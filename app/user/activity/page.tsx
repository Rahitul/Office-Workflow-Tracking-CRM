            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group transition-all">
                    <Users className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors z-10" />
                    <Select
                      id="user"
                      value={selectedUser}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                {[
                  ...
                  <div key={item.id} className="space-y-3 group">
                    <div className={cn("p-3 rounded-xl border border-slate-100 transition-all group-focus-within:border-blue-200 group-focus-within:shadow-md", item.bgColor)}>
            ...
            <CardContent className="p-6 space-y-8">
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  ...
                  <span className="text-[10px] bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full font-bold uppercase tracking-widest">Required • Choose One</span>
                </div>
