...
export default function ServiceTrainingsPage() {
                ...
                {selectedTraining ? (
                  <div className="space-y-4">
                    ...
                    {selectedTraining.status === "in_progress" && (
                      <Button onClick={() => updateStatus(selectedTraining._id, "completed")} className="w-full bg-teal-600 hover:bg-teal-700 text-white">
