            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                  required
                >
                ...
                <div key={training._id} className="p-4 flex items-center justify-between">
                  {editingId === training._id ? (
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      />
                      <Button size="sm" onClick={() => saveEdit(training._id)} disabled={submitting} className="bg-purple-600">
                        Save
                      </Button>
