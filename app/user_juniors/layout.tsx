...
import { LayoutDashboard, ArrowRightLeft, LogOut, Menu, X, User, GraduationCap, TrendingUp, Target, Briefcase } from "lucide-react"
import { cn } from "@/lib/utils"
import NotificationBell from "@/components/notification-bell"

export default function UserJuniorsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (mounted && !useAuthStore.getState().isLoading && !user) {
      router.push("/login")
    } else if (mounted && user && user.role !== "user_juniors" && user.role !== "admin") {
  ...
  const navItems = [
    { href: "/user_juniors/activity", label: "Daily Activity", icon: TrendingUp },
    { href: "/user_juniors/kpi", label: "My KPI", icon: Target },
    { href: "/user_juniors/trainings", label: "My Trainings", icon: GraduationCap },
    { href: "/user_juniors/lead-transfer", label: "Lead Transfer", icon: ArrowRightLeft },
    { href: "/user_juniors/project-tender", label: "Project/Tender", icon: Briefcase },
    { href: "/user_juniors/profile", label: "Profile", icon: User },
  ]
