...
import { assignFormSchema } from "@/lib/validations/form"
...
export async function POST(
  ...
  try {
    ...
    form.assignedTo = validatedData.userIds.map((id) => 
      new (require("mongoose").Types.ObjectId)(id)
    )
    await form.save()
    
    return NextResponse.json({ message: "Form assigned successfully", form })
  } catch (error: any) {
