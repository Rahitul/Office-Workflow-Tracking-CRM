...
export default function ServiceJuniorsTrainingsPage() {
                ...
                {selectedTraining ? (
                  <div className="space-y-4">
                    ...
                    {selectedTraining.status === "in_progress" && (
                      <Button onClick={() => updateStatus(selectedTraining._id, "completed")} className="w-full bg-orange-600 hover:bg-orange-700 text-white">
