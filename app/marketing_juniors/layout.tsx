...
import { LayoutDashboard, ArrowRightLeft, LogOut, Menu, X, User, GraduationCap } from "lucide-react"
import { cn } from "@/lib/utils"
import NotificationBell from "@/components/notification-bell"

export default function MarketingJuniorsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (mounted && !useAuthStore.getState().isLoading && !user) {
      router.push("/login")
    } else if (mounted && user && user.role !== "marketing_juniors" && user.role !== "admin") {
  ...
  const navItems = [
    { href: "/marketing_juniors/trainings", label: "My Trainings", icon: GraduationCap },
    { href: "/marketing_juniors/lead-transfer", label: "Lead Transfer", icon: ArrowRightLeft },
    { href: "/marketing_juniors/profile", label: "Profile", icon: User },
  ]
