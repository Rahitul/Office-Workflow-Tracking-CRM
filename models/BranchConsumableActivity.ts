...
export interface IBranchConsumableActivity extends Document {
...
const BranchConsumableActivitySchema = new Schema<IBranchConsumableActivity>(
  {
...
BranchConsumableActivitySchema.index({ activityDate: 1, userId: 1 })

if (mongoose.models.BranchConsumableActivity) {
  delete mongoose.models.BranchConsumableActivity
}

export const BranchConsumableActivity = mongoose.model<IBranchConsumableActivity>("BranchConsumableActivity", BranchConsumableActivitySchema)
