...
export interface IBranchSalesPhoneCall extends Document {
...
const BranchSalesPhoneCallSchema = new Schema<IBranchSalesPhoneCall>(
  {
...
BranchSalesPhoneCallSchema.index({ userId: 1, date: -1, type: 1 })

if (mongoose.models.BranchSalesPhoneCall) {
  delete mongoose.models.BranchSalesPhoneCall
}

export const BranchSalesPhoneCall = mongoose.model<IBranchSalesPhoneCall>("BranchSalesPhoneCall", BranchSalesPhoneCallSchema)
