...
export default function MarketingJuniorsTrainingsPage() {
                ...
                {selectedTraining ? (
                  <div className="space-y-4">
                    ...
                    {selectedTraining.status === "in_progress" && (
                      <Button onClick={() => updateStatus(selectedTraining._id, "completed")} className="w-full bg-pink-600 hover:bg-pink-700 text-white">
